...
}(function ($, moment)
{
    ...
    $.fn.dateRangePicker = function(opt)
    {
        ...
        opt = $.extend(true,
            {
                ...
                addFirstDate: function(targetElement) {
                },
                removeFirstDate: function(targetElement) {
                },
                addLastDate: function(targetElement) {
                },
                removeLastDate: function(targetElement) {
                },
                showTopbar: true,
                swapTime: false,
        ...
        {
            var forcedExternalElement = false;
            if($(evt.target).data('daterangepicker') && $(evt.target).data('daterangepicker') == $(selfObj).attr('id')) {
                forcedExternalElement = true;
            }

            return ( evt.target == selfObj  || (selfObj.childNodes != undefined && $.inArray(evt.target, selfObj.childNodes)>=0) || forcedExternalElement )
        }
        ...
        function showSelectedDays()
        {
            ...
            box.find('.day').each(function()
            {
                ...
                if ( opt.start && moment(start).format('YYYY-MM-DD') == moment(time).format('YYYY-MM-DD') ) {
                    ...
                    if (opt.addFirstDate) {
                        if (typeof opt.addFirstDate == 'function') {
                            opt.addFirstDate(this);
                        }
                    }
                }
                else
                {
                    ...
                    if (opt.removeFirstDate) {
                        if (typeof opt.removeFirstDate == 'function') {
                            opt.removeFirstDate(this, true);
                        }
                    }
                }
                ...
                if ( opt.end && moment(end).format('YYYY-MM-DD') == moment(time).format('YYYY-MM-DD') )
                {
                    ...
                    if (opt.addLastDate) {
                        if (typeof opt.addLastDate == 'function') {
                            opt.addLastDate(this);
                        }
                    }
                }
                else
                {
                    ...
                    if (opt.removeLastDate) {
                        if (typeof opt.removeLastDate == 'function') {
                            opt.removeLastDate(this);
                        }
                    }
                }
            });
