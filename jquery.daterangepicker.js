        ...
        opt = $.extend(true,
            {
                ...
                addFirstDate: function(targetElement) {
                    // when ever the first-date-selected class will be set
                },

                removeFirstDate: function(targetElement) {
                    // targetElement is the element which triggered the event
                    // when ever the first-date-selected class will be removed
                },
